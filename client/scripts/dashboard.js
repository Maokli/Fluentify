      ...
      <div class="col-md-3 mb-4">
            <div class="card hoverable h-100" style="width: 13rem; height: 10rem;">
                <div class="d-flex justify-content-center">
                 <img src="${
                   language.photo
                 }" class="card-img-top rounded-start flags text-center" alt="${
    language.languageName
            ...
            <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div class="progress w-100 mx-auto">
                        <div class="progress-bar" role="progressbar" style="width: ${parseInt(
                          language.progress * 100
                        )}%;" aria-valuenow="${parseInt(
    language.progress * 100
  )}" aria-valuemin="0" aria-valuemax="100">${parseInt(
    language.progress * 100
  )}%</div>
                    </div>
             </div>
  ...
  .then(function (response) {
    ...
    languages.forEach((language) => {
      ...
      const cardElement = document
        .createRange()
        .createContextualFragment(card).firstElementChild;
